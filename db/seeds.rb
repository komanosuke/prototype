...
User.create(role: '', registered: '2022-12-21', login: 0, display_name: '金沢市', email: 'aaa@mail.com', password_digest: 'aaaa', zip: '000-0000', prefecture: '石川県', address: '金沢市〇〇町', street: '111番地', tel: '111-1111', municipality: '金沢市', division: '〇〇課', image: nil, profile: '〇〇課です。よろしくです。', notification: 'OK', flag: 'OK', admin_memo: '特になし。')
